...
class Config:
    ...
    CSV_OUTPUT_FILE = pathlib.Path(__file__).parent / "test_output.csv"
    FMU_FILE = pathlib.Path(__file__).parent / "test_resources/damped_oscillator/damped_oscillator.fmu"
