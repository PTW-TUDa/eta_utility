...
class BaseEnvLiveConnector(BaseEnv, ABC):
    ...
    def step(self, action: np.ndarray) -> StepResult:
        ...
        self.state = {name: results[self.state_config.map_ext_ids[name]] for name in self.state_config.ext_outputs}
    ...
    def reset(self) -> np.ndarray:
        ...
        for name in self.state_config.ext_outputs:
            start_obs.append(self.state_config.map_ext_ids[name])
